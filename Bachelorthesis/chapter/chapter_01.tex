...
\begin{proof} We will use \(\E[X\mid A]=\sum_{n\in\N} \E[X\mid A \cap B_n] \Pr(B_n \mid A) \) with \({\Pr\left(\biguplus_{n\in\N}B_n\right)=1 }\) (c.f. \ref{appx1}) quite a bit in this proof.
