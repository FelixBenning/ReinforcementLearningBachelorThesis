...
%% Modified (2019) by Felix Benning 
%%

%%option fleqn leftalignes equations
\documentclass[11pt, a4paper]{book}
\usepackage{./macros/dinaA4}
\usepackage{./macros/BScMacros}
\usepackage{./macros/BScTitle}

%% Biblatex (bibliography tool - improvement over bibtex)
...
%% Annotations/Todo list/Comments
\RequirePackage[final]{fixme} %final removes annotations %draft includes annotations
\fxsetup{theme=color}
...
%%
%% Font auswaehlen: '\TimesFont' auskommentiert -> latin modern
%% '\TimesFont' aktiv -> Textfont: times, Mathfont: latin modern
%%
%\TimesFont
%%
